...
import { TeamsChannelAccount, TokenExchangeRequest, TokenResponse } from "botframework-schema";
...
export class TeamsSsoMessagingExtensionAuthentication extends MessagingExtensionAuthenticationBase {
    ...
    public override isValidActivity(context: TurnContext): boolean {
        ...
        return super.isValidActivity(context) && context.activity.name == QUERY_INVOKE_NAME;
    }

    public async handleSsoTokenExchange(context: TurnContext, tokenExchangeRequest: TokenExchangeRequest): Promise<TokenResponse | undefined> {
