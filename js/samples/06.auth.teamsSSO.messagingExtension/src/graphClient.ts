...
export class GraphClient {
    ...
    public async queryUsersAsync(displayName: string) {
        return await this.graphClient
        .api(`/users?$search="displayName:${displayName}"&$count=true`)
    ...
    public async getProfilePhotoAsync(id: string): Promise<string> {
        const graphPhotoEndpoint = `https://graph.microsoft.com/v1.0/${id}/photos/240x240/$value`;
